...
st.set_page_config(
    page_title="AI Generated Visualizations",
    page_icon="📊",
    layout="wide"
)

st.write("# AI Generated Visualizations and Infographics using Large Language Models 📊")
...
if not openai_key:
    openai_key = st.sidebar.text_input("Your OpenAI API Key:")
    if openai_key:
...
st.markdown(
    ...
    "<p class='font_size'>Automated Data Exploration - fully automated, generates meaningful visualization goals. Powered by LLMs.</p>", 
    unsafe_allow_html=True
...
if openai_key:
    ...
    models = ["gpt-4-turbo-preview", "gpt-4-1106-preview", "gpt-4-0125-preview"]
